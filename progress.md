...
- 2025-11-18: Added TDD coverage plus batch translation pipeline in `jira_trans.py` that reduces OpenAI calls to a single JSON-based request while preserving existing bilingual formatting.
